    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          throw new Error((0, _alert.showAlert)('error', 'Error While Logging in'));
        case 7:
          _context.next = 9;
          return res.json();
        case 9:
        ...
        case 14:
          ...
          (0, _alert.showAlert)('error', 'somethimg went wrong while logging in');
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          throw new Error((0, _alert.showAlert)('error', 'Error while logout'));
        case 6:
          _context2.next = 8;
          return res.json();
        case 8:
          data = _context2.sent;
          if (data.status === 'success') {
            (0, _alert.showAlert)('success', 'You are successfully logged out');
            location.assign('/');
          }
          _context2.next = 15;
          break;
        case 12:
          ...
          (0, _alert.showAlert)('error', 'somethimg went wrong while logout');
        case 15:
        case "end":
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 12:
          ...
          if (updatedUser.status === 'success') {
            (0, _alert.showAlert)('success', "Update User ".concat(type, " successfully "));
          }
          _context.next = 19;
          break;
        case 16:
          ...
          _context.t0.text().then(function (errmsg) {
...
var userPassForm = document.querySelector('.form-user-settings');
if (loginForm) {
